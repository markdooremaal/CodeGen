...
public class Transaction   {
  ...
  @Pattern(regexp="^[a-z]{2}[0-9]{2}[a-z0-9]{4}[0-9]{7}([a-z0-9]?){0,16}$")   public String getAccountFrom() {
    return accountFrom;
  }
  ...
  @Pattern(regexp="^[a-z]{2}[0-9]{2}[a-z0-9]{4}[0-9]{7}([a-z0-9]?){0,16}$")   public String getAccountTo() {
    return accountTo;
  }
